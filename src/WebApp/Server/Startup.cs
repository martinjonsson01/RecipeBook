...
namespace RecipeBook.Presentation.WebApp.Server
{
    internal class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.IncludeXmlComments($@"{System.AppDomain.CurrentDomain.BaseDirectory}\RecipeBook.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "RecipeBook API"));
            }
            else
            {
